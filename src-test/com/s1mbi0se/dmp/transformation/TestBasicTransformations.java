...
public class TestBasicTransformations {
	...
	public static void main(String[] args) throws	
			JsonTransformationException, IOException {
		InputStream query = TestBasicTransformations.class.getResourceAsStream("/query.json");
		JsonTransformation jsonTransformation = new JsonTransformation(query);		
		
		InputStream originData1 = TestBasicTransformations.class.getResourceAsStream(
				"/origin_data.json");
		System.out.println("Transformation result 1 = "
				+ jsonTransformation.transform(originData1));
		InputStream originData2 = TestBasicTransformations.class.getResourceAsStream(
				"/origin_data2.json");
